...
```
docker tag prometheus-custom 497196579670.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push 497196579670.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```