...
```
docker tag filebeat-custom 497196579670.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 497196579670.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```